...
class VeloNavigator extends Component {
  ...
  render() {
    ...
    let user_is_admin =
      ...
      (this.context.traits.Permissions.org_admin || this.context.traits.Permissions.server_admin);
    ...
    return (
      <>
        <div className="float-left navigator">
          <span className="hamburger toolbar-buttons" onClick={this.toggle}>
            &#9776;
          </span>
          <a href="#welcome">
            ...
            <div>
              <section className="navigator">
                ...
                {disabled ? (
                  ...
                  <>
                    <NavLink className={disabled} to={"/host/" + this.props.client.client_id}>
                      <ul className="nav nav-pills navigator">
                        <li
                          className={classNames({
                            "nav-link": true,
                    ...
                    <NavLink className={disabled} disabled={disabled} to={"/collected/" + this.props.client.client_id}>
                      <ul className="nav nav-pills navigator">
                        <li
                          className={classNames({
                            "nav-link": true,
                    ...
                    <NavLink className={disabled} disabled={disabled} to={"/events/" + this.props.client.client_id}>
                      <ul className="nav nav-pills navigator">
                        <li
                          className={classNames({
                            "nav-link": true,
                ...
                {_.map(sidebar_links, (x) => {
                  return (
                    <ul key={x.text} className="nav nav-pills navigator">
                      <li
                        className={classNames({
                          "nav-link": true,
                        })}
                      >
                        <a href={x.url} rel="noreferrer" target={x.new_tab ? "_blank" : ""}>
                          <span>
                            <img className="sidebar-icon" alt={x.text} src={x.icon_url} />
                          </span>
                          {T(x.text)}
                        </a>
                      </li>
