...
class VeloFileStats extends Component {
                ...
                specs: [
                    {
                        ...
                        parameters: {
                            env: [
                                { key: "Path", value: selectedRow._FullPath },
    ...
    render() {
        ...
        if (!selectedRow || !selectedRow.Name) {
            return (
                <div className="card">
                    <h5 className="card-header">{T("Click on a file in the table above.")}</h5>
                </div>
            );
        }
                ...
                <Card>
                    ...
                    <Card.Body>
                        <dl className="row">
                            ...
                            <dd className="col-8">{selectedRow.Size}</dd>
                            ...
                            {selectedRow.Download && selectedRow.Download.mtime && (
                                <>
                                    <dt className="col-4">{T("Last Collected")}</dt>
                                    <dd className="col-8">
                                ...
                                <>
                                    ...
                                    <dd className="col-8">
                                        {this.state.updateOperationFlowId ? (
                                            ...
                                            <Button variant="default" onClick={this.updateFile}>
                                                <FontAwesomeIcon icon="sync" />
                                                <span className="button-label">
                                                    {selectedRow.Download && !_.isEmpty(selectedRow.Download.components)
