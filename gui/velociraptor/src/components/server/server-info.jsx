...
class ServerInfo extends Component {
    ...
    fetchMetadata = () => {
        ...
        api.get("v1/GetClientMetadata/server", {}, this.source.token).then((response) => {
        ...
        if (this.state.mode === "shell") {
            return (
                <div className="client-details shell">
                    <ShellViewer client={{ client_id: "server" }} default_shell="Bash" />
                </div>
            );
        }
                ...
                <div className="full-width-height">
                    <div className="client-info">
                        <div className="btn-group float-left toolbar" data-toggle="buttons">
                            <Link to={"/collected/server"} role="button" className="btn btn-default">
                                <i>
