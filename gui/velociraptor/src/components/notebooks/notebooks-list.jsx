...
class NewNotebook extends React.Component {
    ...
    render() {
        return (
            <Modal show={true} size="lg" onHide={this.props.closeDialog}>
                    ...
                    <Form.Group as={Row}>
                        ...
                        <Col sm="8">
                            <Form.Check
                                ...
                                onChange={(e) => this.setState({ public: e.currentTarget.checked })}
                            />
                        </Col>
                    </Form.Group>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" onClick={this.newNotebook}>
                        {T("Submit")}
                    </Button>
                </Modal.Footer>
            </Modal>
...
class DeleteNotebook extends React.Component {
    ...
    deleteNotebook = () => {
        ...
        api.post("v1/UpdateNotebook", notebook, this.source.token).then(this.props.updateNotebooks);
    };
    ...
    render() {
        return (
            <Modal show={true} size="lg" onHide={this.props.closeDialog}>
                <Modal.Header closeButton>
                    <Modal.Title>Archive notebook {this.props.notebook.notebook_id}</Modal.Title>
                </Modal.Header>

                <Modal.Body>
                    <Alert variant="danger" className="text-center">
                        You are about to archive notebook {this.props.notebook.notebook_id}! You can always recover this
                        notebook from the filestore later.
                    </Alert>
                </Modal.Body>
                <Modal.Footer>
                    <Button variant="secondary" onClick={this.props.closeDialog}>
                    ...
                    <Button variant="primary" onClick={this.deleteNotebook}>
                        Do It!!!
                    </Button>
                </Modal.Footer>
            </Modal>
...
class NotebooksList extends React.Component {
    ...
    setFullScreen = () => {
        if (this.props.selected_notebook && this.props.selected_notebook.notebook_id) {
            this.props.history.push("/fullscreen/notebooks/" + this.props.selected_notebook.notebook_id);
        }
    };
    ...
    render() {
        let columns = formatColumns([
            ...
            { dataField: "description", text: T("Description"), sort: true, filtered: true },
            {
                dataField: "created_time",
                text: T("Creation Time"),
                sort: true,
                formatter: (cell, row) => {
        ...
        let selected_notebook = this.props.selected_notebook && this.props.selected_notebook.notebook_id;
        const selectRow = {
            mode: "radio",
            clickToSelect: true,
                ...
                <Navbar className="toolbar">
                    <ButtonGroup>
                        <Button
                            ...
                            disabled={!this.props.selected_notebook || !this.props.selected_notebook.notebook_id}
