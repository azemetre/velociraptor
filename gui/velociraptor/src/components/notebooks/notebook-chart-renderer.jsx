...
import { VeloLineChart, VeloTimeChart, VeloScatterChart, VeloBarChart } from "../artifacts/line-charts.jsx";
    ...
    fetchRows = () => {
        ...
        api.get(url, params, this.source.token)
            .then((response) => {
                ...
                this.setState({ loading: false, rows: pageData.rows, columns: columns });
            })
            .catch((e) => {
