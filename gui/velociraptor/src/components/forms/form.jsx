...
export default class VeloForm extends React.Component {
    ...
    maybeFetchArtifacts(artifact_type) {
        if (!artifact_type || !this.props.param || this.props.param.type !== "artifactset") {
            return;
        }
    ...
    updateMulti(newChoices) {
        ...
        this.props.setValue(
            serializeCSV(
                _.map(choices, function (item, idx) {
                    return [item];
                }),
                ["Artifact"]
            )
    ...
    render() {
        ...
        switch (param.type) {
                                    ...
                                    <ButtonGroup>
                                        <Button
                                            ...
                                            onClick={() => {
                                                ...
                                                this.props.setValue(serializeCSV(data.data, data.columns));
                                            }}
                                        >
            ...
            case "regex":
                return (
                    <Form.Group as={Row}>
                        ...
                        <Col sm="8">
                            <RegEx value={this.props.value} setValue={this.props.setValue} />
                        </Col>
                    </Form.Group>
                );
            ...
            case "regex_array":
                return (
                    <Form.Group as={Row}>
                        ...
                        <Col sm="8">
                            <RegExArray value={this.props.value} setValue={this.props.setValue} />
                        </Col>
                    </Form.Group>
                );
            ...
            case "yara":
                return (
                    <Form.Group as={Row}>
                        ...
                        <Col sm="8">
                            <YaraEditor value={this.props.value} setValue={this.props.setValue} />
                        </Col>
                    </Form.Group>
                );
            ...
            case "artifactset":
                ...
                if (this.state.multichoices === undefined || this.state.artifact_loading) {
                    return <></>;
                }
                    ...
                    return (
                        <Form.Group as={Row}>
                            <Alert variant="danger">
                                Warning: No artifacts found for type {this.props.param.artifact_type}.
                            </Alert>
                        </Form.Group>
                    );
                }
            ...
            case "upload":
                return (
                    <UploadFileForm param={this.props.param} value={this.props.value} setValue={this.props.setValue} />
                );
            default:
                return (
                    <Form.Group as={Row}>
