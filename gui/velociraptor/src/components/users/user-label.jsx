        ...
        return (
            <>
                ...
                {this.state.password1 && this.state.password2 && (
                    <Button
                        variant={this.state.password1 !== this.state.password2 ? "warning" : "default"}
                        size="sm"
...
class UserSettings extends React.PureComponent {
    ...
    render() {
        return (
            <Modal show={true} dialogClassName="modal-70w" onHide={this.props.onClose}>
                ...
                <Modal.Body>
                        ...
                        <Form.Group as={Row}>
                            <Form.Label column sm="3">
                                <OverlayTrigger
                                    ...
                                    overlay={(props) => <Tooltip {...props}>{T("Switch to a different org")}</Tooltip>}
                                >
                    ...
                    {!this.context.traits.password_less && (
                        <PasswordChangeForm onClose={this.props.onClose}></PasswordChangeForm>
                    )}
                    <Form.Group as={Row}>
                        <Form.Label column sm="3">
                            {T("Theme")}
                    ...
                    <Form.Group as={Row}>
                        <Form.Label column sm="3">
                            <OverlayTrigger
                                delay={{ show: 250, hide: 400 }}
                                overlay={(props) => <Tooltip {...props}>{T("Select a language")}</Tooltip>}
                            >
                                <div>{T("Language")}</div>
                            </OverlayTrigger>
                        </Form.Label>
                    ...
                    <Form.Group as={Row}>
                        <Form.Label column sm="3">
                            <OverlayTrigger
                                delay={{ show: 250, hide: 400 }}
                                overlay={(props) => <Tooltip {...props}>{T("Select a timezone")}</Tooltip>}
                            >
        ...
        return (
            <>
                ...
                <ButtonGroup className="user-label">
                    <Button
                        href={api.href("/app/logoff.html", {
                            username: this.context.traits.username,
                        })}
                    >
                        <FontAwesomeIcon icon="sign-out-alt" />
                    </Button>
                    <Button variant="default" onClick={() => this.setState({ showUserSettings: true })}>
                        {this.context.traits.username}
                        {this.context.traits.picture && (
                            <img
                                className="toolbar-buttons img-thumbnail"
                                alt="avatar"
