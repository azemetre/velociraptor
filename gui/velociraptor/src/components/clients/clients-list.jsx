...
export class LabelClients extends Component {
    ...
    labelClients = () => {
        ...
        let client_ids = _.map(this.props.affectedClients, (client) => client.client_id);
    ...
    render() {
        ...
        return (
            <Modal show={true} size="lg" onHide={this.props.onResolve}>
                ...
                <Modal.Footer>
                    <Button variant="secondary" onClick={this.props.onResolve}>
                        {T("Close")}
                    </Button>
                    <Button variant="primary" onClick={this.labelClients}>
                        {T("Add it!")}
                    </Button>
                </Modal.Footer>
            </Modal>
    ...
    deleteClients = () => {
        ...
        api.post(
            "v1/CollectArtifact",
            {
                ...
                specs: [
                    {
                        artifact: "Server.Utils.DeleteClient",
                        parameters: {
                            env: [
    ...
    render() {
        ...
        return (
            <Modal show={true} size="lg" onHide={this.props.onResolve}>
                ...
                <Modal.Body>
                    <Alert variant="danger">{T("DeleteMessage")}</Alert>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" disabled={this.state.flow_id} onClick={this.deleteClients}>
...
class VeloClientList extends Component {
    ...
    componentDidMount = () => {
        this.source = axios.CancelToken.source();
        let query = this.props.match && this.props.match.params && this.props.match.params.query;
    ...
    render() {
        ...
        let total_size = this.state.clients.length + this.state.start_row;
        ...
        columns.push({
            ...
            formatter: (cell, row) => {
                return _.map(cell, (label, idx) => {
                    return (
                        <Button size="sm" key={idx} onClick={() => this.removeLabel(label, row)} variant="default">
    ...
    return formatColumns([
        {
            ...
            formatter: (cell, row) => {
                return (
                    <Button variant="outline-default" className="online-status">
                        <span className="button-label">
