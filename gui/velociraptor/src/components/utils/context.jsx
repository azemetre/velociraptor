    ...
    render() {
        ...
        return (
            <Menu id={MENU_ID}>
                <Item
                    onClick={(e) => {
                        e.props && navigator.clipboard.writeText(e.props && e.props.value);
                    }}
                >
                ...
                {_.map(context_links, (x) => {
                    return (
                        <Item key={x.text} onClick={(e) => this.handleClick(x, e.props && e.props.value)}>
                            {x.icon_url && (
                                <span>
                                    <img className="context-icon" alt={x.text} src={x.icon_url} />
                                </span>
                            )}
                            {x.text}
                        </Item>
