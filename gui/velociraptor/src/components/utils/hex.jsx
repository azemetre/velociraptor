            ...
            >
                ...
                <Modal.Body>
                    <div className="hex-dialog-body">
                        <HexView byte_array={this.props.byte_array} data={this.props.data} height={50} />
                    </div>
                </Modal.Body>
                <Modal.Footer>
...
export default class HexView extends React.Component {
    ...
    componentDidUpdate = (prevProps, prevState, rootNode) => {
        if (!_.isEqual(prevProps.data, this.props.data) || !_.isEqual(prevProps.byte_array, this.props.byte_array)) {
            this.updateRepresentation();
        }
    };
            ...
            <div className="panel hexdump">
                <div className="monospace">
                    <table>
                        <thead>
                            <tr>
                                <th className="offset-area">Offset</th>
                                <th className="padding-area">00 01 02 03 04 05 06 07 08 09 0a 0b 0c 0d 0e 0f</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td className="hex-container">{hexArea}</td>
                                <td className="hex-container">{contextArea}</td>
                            </tr>
                            {more &&
                                (this.state.expanded ? (
                                    <tr>
