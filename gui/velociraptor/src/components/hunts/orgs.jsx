...
export default class OrgSelector extends Component {
    ...
    render() {
        ...
        // orgs at all.
        let has_perm =
            this.context.traits && this.context.traits.Permissions && this.context.traits.Permissions.org_admin;
        ...
        let options = _.map(this.context.traits.orgs, (x) => {
            return { value: x.id, label: x.name, isFixed: true, color: "#00B8D9" };
        });
    ...
    render() {
        return (
            <Form.Group as={Row}>
                ...
                <Col sm="8">
                    <OrgSelector onChange={this.props.onChange} value={this.props.value} />
                </Col>
            </Form.Group>
        );
    }
