...
class NewHuntConfigureHunt extends React.Component {
    ...
    render() {
        let is_admin =
            this.context.traits && this.context.traits.Permissions && this.context.traits.Permissions.server_admin;
                ...
                <Modal.Body>
                    <Form>
                        ...
                        <Form.Group as={Row}>
                            ...
                            <Col sm="8">
                                <DateTimePicker
                                    value={this.props.parameters.expires}
                        ...
                        <Form.Group as={Row}>
                            ...
                            <Col sm="8">
                                <Form.Control
                                    ...
                                    onChange={(e) => this.setParam("include_condition", e.currentTarget.value)}
                                >
                                    <option label={T("Run everywhere")} value="">
                                        {T("Run everywhere")}
                                    </option>
                                    <option label={T("Match by label")} value="labels">
                                        {T("Match by label")}
                                    </option>
                                    <option label={T("Operating System")} value="os">
                                        {T("Operating System")}
                                    </option>
                                </Form.Control>
                            </Col>
                        ...
                        {this.props.parameters.include_condition === "os" && (
                            <Form.Group as={Row}>
                                <Form.Label column sm="3">
                                    {T("Operating System Included")}
                                </Form.Label>
                                <Col sm="8">
                                    <Form.Control
                                        as="select"
                                        value={this.props.parameters.include_os}
                                        onChange={(e) => this.setParam("include_os", e.currentTarget.value)}
                                    >
                                        <option label={T("ALL")} value="ALL">
                                            {T("ALL")}
                                        </option>
                        ...
                        <Form.Group as={Row}>
                            ...
                            <Col sm="8">
                                <Form.Control
                                    ...
                                    onChange={(e) => this.setParam("exclude_condition", e.currentTarget.value)}
                                >
                                    <option label={T("Run everywhere")} value="">
                                        {T("Run everywhere")}
                                    </option>
                            ...
                            <Form.Group as={Row}>
                                ...
                                <Col sm="8">
                                    <Form.Check
                                        ...
                                        onChange={(e) =>
                                            this.setParam("force_start", !this.props.parameters.force_start)
                                        }
                                    />
                                </Col>
                            </Form.Group>
...
export default class NewHuntWizard extends React.Component {
    ...
    setStateFromBase = (hunt) => {
        ...
        if (request) {
            ...
            let os = hunt.condition && hunt.condition.os && hunt.condition.os.os;
            if (!_.isEmpty(os)) {
                state.hunt_parameters.include_os = os;
                state.hunt_parameters.include_condition = "os";
            }

            let excluded = hunt.condition && hunt.condition.excluded_labels && hunt.condition.excluded_labels.labels;
    ...
    prepareRequest = () => {
        ...
        if (hunt_parameters.include_condition === "os" && hunt_parameters.include_os !== "ALL") {
                    ...
                    <ObserveKeys>
                        <StepWizard ref={(n) => (this.step = n)}>
                            ...
                            <NewCollectionResources
                                ...
                                paginator={
                                    new HuntPaginator("Specify Resources", "Create Hunt: Specify resource limits")
                                }
                                setResources={this.setResources}
                            />

                            <NewCollectionRequest
                                paginator={new HuntPaginator("Review", "Create Hunt: Review request")}
                                request={this.prepareRequest()}
                            />

                            <NewCollectionLaunch
                                artifacts={this.state.artifacts}
                                paginator={new PaginationBuilder("Launch", "Create Hunt: Launch hunt")}
                                launch={this.launch}
                            />
                        </StepWizard>
                    </ObserveKeys>
