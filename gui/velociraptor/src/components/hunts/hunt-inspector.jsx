...
class HuntInspector extends React.Component {
    ...
    setDefaultTab = (tab) => {
        ...
        this.props.history.push("/hunts/" + this.props.hunt.hunt_id + "/" + tab);
    };
            ...
            <div className="padded">
                <Tabs defaultActiveKey={tab} onSelect={this.setDefaultTab}>
                    <Tab eventKey="overview" title={T("Overview")}>
                        {tab === "overview" && (
                            <HuntOverview fetch_hunts={this.props.fetch_hunts} hunt={this.props.hunt} />
                        )}
                    </Tab>
                    <Tab eventKey="requests" title={T("Requests")}>
                        {tab === "requests" && <HuntRequest hunt={this.props.hunt} />}
                    </Tab>
                    <Tab eventKey="clients" title={T("Clients")}>
                        {tab === "clients" && <HuntClients hunt={this.props.hunt} />}
                    </Tab>
                    <Tab eventKey="notebook" title={T("Notebook")}>
                        {tab === "notebook" && <HuntNotebook hunt={this.props.hunt} />}
                    </Tab>
                </Tabs>
            </div>
        );
