...
class VeloHunts extends React.Component {
    ...
    fetchHunts = () => {
        let selected_hunt_id = this.props.match && this.props.match.params && this.props.match.params.hunt_id;
        ...
        api.get(
            ...
            if (!this.state.init_router && !selected_hunt_id) {
                selected_hunt_id = this.props.match && this.props.match.params && this.props.match.params.hunt_id;
        ...
        return (
            <>
                ...
                <SplitPane split="horizontal" defaultSize="30%">
                    ...
                    />
                    <HuntInspector fetch_hunts={this.fetchHunts} hunt={this.state.full_selected_hunt} />
                </SplitPane>
            </>
        );
    }
