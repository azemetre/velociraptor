...
class ArtifactInspector extends React.Component {
    ...
    componentDidMount = () => {
        ...
        let artifact_name = this.props.match && this.props.match.params && this.props.match.params.artifact;

        if (!artifact_name) {
            this.fetchRows("...");
            return;
        }
        this.setState({ selectedDescriptor: { name: artifact_name }, current_filter: artifact_name });
    ...
    render() {
        ...
        let deletable = this.state.selectedDescriptor && !this.state.selectedDescriptor.built_in;
        ...
        return (
            <div className="full-width-height">
                ...
                <Navbar className="artifact-toolbar justify-content-between">
                    <ButtonGroup>
                        <Button
                            data-tooltip={T("Add an Artifact")}
                            data-position="right"
                        ...
                        <Button
                            data-tooltip={T("Edit an Artifact")}
                            data-position="right"
                            className="btn-tooltip"
                            onClick={() => {
                        ...
                        <Button
                            data-tooltip={T("Delete Artifact")}
                            data-position="right"
                            className="btn-tooltip"
                        ...
                        <Button
                            data-tooltip={T("Collect Artifact")}
                            data-position="right"
                            className="btn-tooltip"
                        ...
                        <Button
                            data-tooltip={T("Upload Artifact Pack")}
                            data-position="right"
                            className="btn-tooltip"
                    ...
                    <Form inline className="">
                        <InputGroup>
                            <InputGroup.Prepend>
                                <Button variant="outline-default" onClick={() => this.updateSearch("")} size="sm">
                                    {this.state.loading ? (
                                        ...
                                        return (
                                            ...
                                            >
                                                <td onClick={(e) => this.onSelect(item, e)}>
                                                    ...
                                                    <a href="#" onClick={(e) => this.onSelect(item, e)}>
                                                        {item.name}
                                                    </a>
