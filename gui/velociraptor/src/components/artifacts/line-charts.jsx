...
const strokes = ["#ff7300", "#f48f8f", "#207300", "#f4208f"];

const shapes = ["star", "triangle", "circle"];
    ...
    render() {
        ...
        return (
            <g transform={`translate(${this.props.x},${this.props.y})`}>
                <text x={0} y={0} dy={16} textAnchor="end" fill="#666" transform={this.props.transform}>
...
export class VeloLineChart extends React.Component {
    ...
    getAxisYDomain = (from, to, ref, offset) => {
        ...
        // last x_column value.
        let refData = _.filter(this.props.data, (x) => x[x_column] >= from / factor && x[x_column] <= to / factor);
    ...
    render() {
        ...
        let xaxis_mode = this.props.params && this.props.params.xaxis_mode;
        if (xaxis_mode === "time") {
            tick_renderer = <TimeTickRenderer data={data} transform="rotate(-35)" dataKey={x_column} />;
        }
            ...
            <div onDoubleClick={this.zoomOut}>
                <ResponsiveContainer width="95%" height={600}>
                    ...
                    >
                        ...
                        />
                        <Tooltip content={<CustomTooltip data={data} columns={this.props.columns} />} />
                        {lines}
...
export class VeloTimeChart extends VeloLineChart {
    ...
    render() {
        ...
        let x_column = columns[0];
        let tick_renderer = <TimeTickRenderer data={data} transform="rotate(-35)" dataKey={x_column} />;
                ...
                <ResponsiveContainer width="95%" height={600}>
                    ...
                    >
                        <XAxis
                            ...
                            tick={tick_renderer}
                        />
                        <YAxis allowDataOverflow domain={[this.state.bottom || 0, this.state.top || 0]} />
                        <Tooltip content={<CustomTooltip data={data} columns={this.props.columns} />} />
                        {lines}
                        <CartesianGrid stroke="#f5f5f5" />
                        {this.state.refAreaLeft && this.state.refAreaRight ? (
...
export class VeloBarChart extends VeloLineChart {
    ...
    render() {
        ...
        return (
            <ResponsiveContainer width="95%" height={600}>
                <BarChart className="velo-line-chart" data={data}>
...
export class VeloScatterChart extends VeloLineChart {
    ...
    render() {
        ...
        return (
            <ResponsiveContainer width="95%" height={600}>
                <ScatterChart className="velo-line-chart" data={data}>
                    <CartesianGrid strokeDasharray="3 3" />
