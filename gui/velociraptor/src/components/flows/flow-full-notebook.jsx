...
class FullScreenFlowNotebook extends React.Component {
    ...
    componentDidMount = () => {
        let flow_id = this.props.match && this.props.match.params && this.props.match.params.flow_id;
    ...
    setSelectedNotebook = () => {
        this.props.history.push("/collected/" + this.state.client_id + "/" + this.state.flow_id + "/notebook");
    };
            ...
            <>
                <Navbar className="toolbar">
                    <ButtonGroup className="float-right floating-button">
                        <Button title={T("Exit Fullscreen")} onClick={this.setSelectedNotebook} variant="default">
