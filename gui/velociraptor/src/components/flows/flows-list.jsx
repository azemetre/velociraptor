    ...
    startDeleteFlow = () => {
        ...
        if (flow_id && client_id) {
            ...
            runArtifact(
                ...
                { FlowId: flow_id, ClientId: client_id, ReallyDoIt: "Y" },
                () => {
                    this.props.onClose();
        ...
        return (
            <Modal show={true} onHide={this.props.onClose}>
                ...
                <Modal.Body>
                    ...
                    {T("ArtifactDeletionDialog", this.props.flow.session_id, artifacts, total_bytes, total_rows)}
                </Modal.Body>
                <Modal.Footer>
        ...
        return (
            <Modal show={true} onHide={this.props.onClose}>
                ...
                <Modal.Body>
                    ...
                    />
                    <VeloForm
                        param={{ name: "Description", description: T("Describe this favorite") }}
...
class FlowsList extends React.Component {
    ...
    componentDidMount = () => {
        ...
        let action = this.props.match && this.props.match.params && this.props.match.params.flow_id;

        let client_id = this.props.match && this.props.match.params && this.props.match.params.client_id;

        let name = this.props.match && this.props.match.params && this.props.match.params.tab;
    ...
    setCollectionRequest = (request) => {
        ...
        api.post("v1/CollectArtifact", request, this.source.token).then((response) => {
    ...
    gotoTab = (tab) => {
        let client_id = this.props.selected_flow && this.props.selected_flow.client_id;
        let selected_flow = this.props.selected_flow && this.props.selected_flow.session_id;
        this.props.history.push("/collected/" + client_id + "/" + selected_flow + "/" + tab);
    };
    ...
    setFullScreen = () => {
        ...
        if (client_id && selected_flow) {
            this.props.history.push("/fullscreen/collected/" + client_id + "/" + selected_flow + "/notebook");
        }
    };
            ...
            <>
                ...
                <Navbar className="flow-toolbar">
                    <ButtonGroup>
                        ...
                        <Button
                            data-tooltip={T("Delete Artifact Collection")}
                            data-position="right"
                            className="btn-tooltip"
                        ...
                        <Button
                            data-tooltip={T("Cancel Artifact Collection")}
                            data-position="right"
                            disabled={
                        ...
                        <Button
                            data-tooltip={T("Copy Collection")}
                            data-position="right"
                            className="btn-tooltip"
                        ...
                        <Button
                            data-tooltip={T("Save Collection")}
                            data-position="right"
                            className="btn-tooltip"
                            onClick={() =>
                                this.setState({
                        ...
                        {isServer && (
                            <Button
                                data-tooltip={T("Build offline collector")}
                                data-position="right"
                                className="btn-tooltip"
                    ...
                    {tab === "notebook" && (
                        <ButtonGroup className="float-right">
                            ...
                            <Button
                                data-tooltip={T("Delete Notebook")}
                                data-position="left"
                                className="btn-tooltip"
                            ...
                            <Button
                                data-tooltip={T("Notebook Uploads")}
                                data-position="left"
                                className="btn-tooltip"
                            ...
                            <Button
                                data-tooltip={T("Export Notebook")}
                                data-position="left"
                                className="btn-tooltip"
...
export function getFlowColumns(client_id) {
    return formatColumns([
        { dataField: "state", text: T("State"), sort: true, formatter: stateRenderer },
        { dataField: "session_id", text: T("FlowId"), type: "flow" },
        {
            dataField: "request.artifacts",
            text: T("Artifacts"),
            sort: true,
            filtered: true,
            formatter: (cell, row) => {
        ...
        { dataField: "create_time", text: T("Created"), sort: true, type: "timestamp" },
        { dataField: "active_time", text: T("Last Active"), sort: true, type: "timestamp" },
        { dataField: "request.creator", text: T("Creator"), sort: true, filtered: true },
        { dataField: "total_uploaded_bytes", text: T("Mb"), align: "right", sort: true, sortNumeric: true, type: "mb" },
        { dataField: "total_collected_rows", text: T("Rows"), sort: true, sortNumeric: true, align: "right" },
    ]);
}
