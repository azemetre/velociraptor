...
export default class FlowUploads extends React.Component {
    ...
    fetchRows = () => {
        ...
        api.get("v1/GetTable", params, this.source.token)
            .then((response) => {
                ...
                this.setState({ loading: false, headers: headers, pageData: prepared_data });
            })
            .catch(() => {
    ...
    render() {
        ...
        let renderers = {
            Preview: (cell, row, rowIndex) => {
                ...
                let components = normalizeComponentList(row._Components, client_id, flow_id);
            ...
            vfs_path: (cell, row, rowIndex) => {
                    ...
                    return (
                        <>
                            <OverlayTrigger
                                ...
                                overlay={(props) => {
                                    return <Tooltip {...props}>Download padded file.</Tooltip>;
                                }}
                            >
                                <Button
                                    as="a"
                ...
                return (
                    <OverlayTrigger
                        delay={{ show: 250, hide: 400 }}
                        overlay={(props) => {
                            return <Tooltip {...props}>Download file.</Tooltip>;
                        }}
                    >
                        <Button
                            as="a"
