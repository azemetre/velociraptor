...
class ClientFlowsView extends React.Component {
    ...
    fetchFlows = () => {
        ...
        api.get(
            ...
            if (!this.state.init_router) {
                selected_flow_id = this.props.match && this.props.match.params && this.props.match.params.flow_id;
    ...
    setSelectedFlow = (flow) => {
        ...
        // Update the route.
        if (tab) {
            this.props.history.push("/collected/" + this.props.client.client_id + "/" + flow.session_id + "/" + tab);
        } else {
            this.props.history.push("/collected/" + this.props.client.client_id + "/" + flow.session_id);
        }
    };
        ...
        return (
            <>
                ...
                <SplitPane split="horizontal" defaultSize="30%">
                    ...
                    />
                    <FlowInspector flow={this.state.currentFlow} client={this.props.client} />
                </SplitPane>
            </>
        );
    }
