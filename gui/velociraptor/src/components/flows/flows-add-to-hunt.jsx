...
export default class AddFlowToHuntDialog extends React.Component {
    ...
    fetchCompatibleHunts = () => {
        let artifacts = this.props.flow && this.props.flow.request && this.props.flow.request.artifacts;
    ...
    render() {
        ...
        let columns = formatColumns([
            ...
            { dataField: "create_time", text: T("Created"), type: "timestamp", sort: true },
        ]);

        return (
            <Modal show={true} className="max-height" dialogClassName="modal-90w" onHide={this.props.onClose}>
                ...
                <Modal.Body>
                    ...
                    {_.isEmpty(this.state.hunts) ? (
                        <>
                            ...
                            <p>{T("Please create a hunt that collects one or more of the following artifacts.")}</p>
