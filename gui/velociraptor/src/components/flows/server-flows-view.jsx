...
class ServerFlowsView extends React.Component {
    ...
    fetchFlows = () => {
        let selected_flow_id = this.props.match && this.props.match.params && this.props.match.params.flow_id;
    ...
    setSelectedFlow = (flow) => {
        ...
        // Update the route.
        if (tab) {
            this.props.history.push("/collected/server/" + flow.session_id + "/" + tab);
        } else {
            this.props.history.push("/collected/server/" + flow.session_id);
        }
    };
        ...
        return (
            <>
                <SplitPane split="horizontal" defaultSize="30%">
                    ...
                    />
                    <FlowInspector flow={this.state.currentFlow} client={{ client_id: "server" }} />
                </SplitPane>
            </>
        );
    }
