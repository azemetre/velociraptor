            ...
            <div className="padded">
                <Tabs activeKey={this.state.tab} onSelect={(tab) => this.setState({ tab: tab })}>
                    <Tab eventKey="overview" title={T("Artifact Collection")}>
                        {this.state.tab === "overview" && <FlowOverview flow={this.props.flow} />}
                    </Tab>
                    ...
                    <Tab eventKey="results" title={T("Results")}>
                        {this.state.tab === "results" && <FlowResults flow={this.props.flow} />}
                    </Tab>
                    <Tab eventKey="logs" title={T("Log")}>
                        {this.state.tab === "logs" && <FlowLogs flow={this.props.flow} />}
                    </Tab>
                </Tabs>
            </div>
        );
            ...
            <>
                {this.state.showFlowInspector && (
                    ...
                    >
                        ...
                        <Modal.Footer>
                            <Button variant="secondary" onClick={() => this.setState({ showFlowInspector: false })}>
                                {T("Close")}
                            </Button>
                        </Modal.Footer>
                    </Modal>
                )}
                <Button size="sm" className="client-link" onClick={this.fetchFullFlow} variant="outline-info">
