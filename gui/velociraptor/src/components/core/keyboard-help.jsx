    ...
    renderKey = (key) => {
        ...
        for (let i = 0; i < parts.length; i++) {
            ...
            switch (part) {
                ...
                case "shift":
                case "ctrl":
                    results.push(<span className="highlight ctrl">&lt;{part}&gt;</span>);
                    break;
                default:
                    ...
                    {_.map(specs, (spec, v) => {
                        ...
                        return (
                            <React.Fragment key={v}>
                                <tr>
                                    <td></td>
                                    <td className="heading">{T(title)}</td>
                                </tr>
                                {_.map(desc, (x, i) => {
                                    return (
                                        <tr key={i}>
                                            <td className="key">{this.renderKey(x[0])} :</td>
            ...
            <>
                ...
                {this.state.showHelp && (
                    <>
                        ...
                        />
                        <div className="keyboard-help" onClick={() => this.setState({ showHelp: false })}>
                            <div className="keyboard-help-content">
                                <table className="page-heading">
                                    <tbody>
                                        <tr>
                                            <td>{T("Keyboard shortcuts")}</td>
                                            <td>
                                                <Button size="lg" className="float-right" variant="link">
                                ...
                                <div className="help-content">
                                    <table cellPadding="0">
                                        <tbody>
                                            <tr>
                                                <td className="column">{this.makeColumn(helpTextCol1)}</td>
                                                <td className="column">{this.makeColumn(helpTextCol2)}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
