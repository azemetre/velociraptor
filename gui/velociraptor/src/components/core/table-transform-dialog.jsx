        ...
        return (
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>{T("Transform table")}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form.Group as={Row}>
                    ...
                    />
                    {this.state.filter_column && this.state.filter_column !== "Unset" && (
                        <VeloForm
                            param={{ name: "filter_regex", friendly_name: T("Filter Regex"), type: "regex" }}
                ...
                <Modal.Footer>
                    <Navbar className="w-100 justify-content-between">
                        <ButtonGroup className="float-right">
                            ...
                            <Button variant="primary" onClick={this.saveTransform}>
