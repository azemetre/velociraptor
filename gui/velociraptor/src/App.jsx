        ...
        return (
            <div>
                <Navbar fixed="top" className="main-navbar justify-content-between">
                    <Form inline>
                        <VeloNavigator vfs_path={vfs_path} client={this.state.client} />

                        <VeloClientSearch setSearch={this.setClientSearch} />
                    </Form>
                    <VeloClientSummary setClient={this.setClient} client={this.state.client} />
                ...
                <div id="content">
                    <Switch>
                        ...
                        <Route path="/host/:client_id([^/]{7,})/:action?">
                            ...
                            <VeloHostInfo client={this.state.client} setClient={this.setClient} />
                        </Route>
